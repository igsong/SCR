 ...
 * </copyright>
 *
 * $Id: JoinImpl.java,v 1.1 2011-02-21 04:15:40 igsong Exp $
 */
 ...
 * <ul>
 *   <li>{@link kr.ac.kaist.se.interaction.idl.impl.JoinImpl#getIncomings <em>Incomings</em>}</li>
 *   <li>{@link kr.ac.kaist.se.interaction.idl.impl.JoinImpl#getOutgoings <em>Outgoings</em>}</li>
 *   <li>{@link kr.ac.kaist.se.interaction.idl.impl.JoinImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link kr.ac.kaist.se.interaction.idl.impl.JoinImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class JoinImpl extends ENamedElementImpl implements Join {
	/**
	...
	protected EClass eStaticClass() {
		return IdlPackage.Literals.JOIN;
	}
	...
	public EList<Edge> getIncomings() {
		if (incomings == null) {
			incomings = new EObjectWithInverseResolvingEList<Edge>(Edge.class, this, IdlPackage.JOIN__INCOMINGS, IdlPackage.EDGE__TARGET);
		}
		return incomings;
	}
	...
	public EList<Edge> getOutgoings() {
		if (outgoings == null) {
			outgoings = new EObjectWithInverseResolvingEList<Edge>(Edge.class, this, IdlPackage.JOIN__OUTGOINGS, IdlPackage.EDGE__SOURCE);
		}
		return outgoings;
	}
	...
	public Choreography getOwner() {
		if (eContainerFeatureID() != IdlPackage.JOIN__OWNER) return null;
	...
	public NotificationChain basicSetOwner(Choreography newOwner, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newOwner, IdlPackage.JOIN__OWNER, msgs);
		return msgs;
	}
	...
	public void setOwner(Choreography newOwner) {
		if (newOwner != eInternalContainer() || (eContainerFeatureID() != IdlPackage.JOIN__OWNER && newOwner != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, IdlPackage.JOIN__OWNER, newOwner, newOwner));
	}
	...
	public void setType(GatewayType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IdlPackage.JOIN__TYPE, oldType, type));
	}
